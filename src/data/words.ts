...
/**
 * Level dictionaries defining character sets for each keyboard layout and level
 * Migrated from archive/logic/layoutInfo.js
 */
export const levelDictionaries: Record<string, Record<string, string>> = {
	azerty: {
		lvl1: "qsdfjklm",
		lvl2: "gh",
		lvl3: "azer",
...
export function getLevelCharacters(layout: string, level: number): string {
	...
	if (!levelDictionaries[layoutKey]) {
		throw new Error(`Unknown layout: ${layout}`);
	}

	if (!levelDictionaries[layoutKey][levelKey]) {
